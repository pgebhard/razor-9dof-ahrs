...
const float magn_ellipsoid_center[3] = {-21.5893, 58.0161, -34.2156};
const float magn_ellipsoid_transform[3][3] = {{0.898668, -0.0115063, -0.0215678}, {-0.0115063, 0.944540, -0.000643014}, {-0.0215678, -0.000643014, 0.995349}};

// Gyroscope
// "gyro x,y,z (current/average) = .../OFFSET_X  .../OFFSET_Y  .../OFFSET_Z
#define GYRO_AVERAGE_OFFSET_X ((float) -29.94)
#define GYRO_AVERAGE_OFFSET_Y ((float) -22.49)
#define GYRO_AVERAGE_OFFSET_Z ((float) -2.06)
